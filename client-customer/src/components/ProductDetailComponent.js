  ...
  render() {
    ...
    return (
      ...
      <div className="flex justify-center py-10 px-4">
        <div className="w-full max-w-4xl bg-white shadow-lg rounded-lg p-6 flex flex-col md:flex-row">
          ...
          <div className="flex-grow">
            ...
            <form onSubmit={(e) => this.btnAdd2CartClick(e)}>
              <div className="space-y-4 text-gray-700">
                <div className="flex">
                  <div className="w-32 font-semibold">ID:</div>
                  <div>{prod._id}</div>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  <div className="w-32 font-semibold">Price:</div>
                  <div>{prod.price}</div>
                </div>
                <div className="flex">
                ...
                <div className="pt-4">
                  <button
                    type="submit"
                    className="bg-gray-900 hover:bg-gray-900 text-white px-6 py-2 rounded shadow-md transition"
                  >
                    ADD TO CART
                  </button>
                </div>
