  ...
  render() {
        ...
        <div key={item._id} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300">
          <figure className="p-4 flex flex-col items-center">
            ...
            <figcaption className="mt-4 text-center">
              <h3 className="text-lg font-semibold text-black text-left">{item.name}</h3>
              <p className="text-red-500 font-bold mt-1 text-left">{item.price}đ</p>
            </figcaption>
          </figure>
        </div>
      );
    ...
    return (
      <div className="min-h-screen bg-gray-100 py-10 px-4">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-10">DANH SÁCH SẢN PHẨM</h2>
