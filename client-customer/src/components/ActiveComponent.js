    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-2xl font-bold text-center text- mb-6 text-gray-900 ">KÍCH HOẠT TÀI KHOẢN</h2>
          <form onSubmit={(e) => this.btnActiveClick(e)}>
            <div className="mb-4">
              <label className="block mb-1 font-medium text-gray-700">ID người dùng</label>
              <input
                type="text"
            ...
            <div className="mb-6">
              <label className="block mb-1 font-medium text-gray-700">Token kích hoạt</label>
              <input
                type="text"
