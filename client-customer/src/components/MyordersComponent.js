...
class Myorders extends Component {
  ...
  render() {
    ...
    const orders = this.state.orders.map((item) => {
      return (
        <tr key={item._id} className="cursor-pointer hover:bg-gray-100" onClick={() => this.trItemClick(item)}>
    ...
    return (
      <div className="min-h-screen bg-gray-50 py-10 px-4">
        <div className="text-center mb-6">
          <h2 className="text-3xl font-bold text-black">ORDER LIST</h2>
        </div>
        ...
        {this.state.order && (
          <div className="mt-10">
            <div className="text-center mb-6">
              <h2 className="text-3xl font-bold text-black">ORDER DETAIL</h2>
            </div>
            <div className="overflow-x-auto bg-white shadow-md rounded-lg">
              <table className="min-w-full text-sm text-gray-700">
                <thead className="bg-gray-900 text-white">
