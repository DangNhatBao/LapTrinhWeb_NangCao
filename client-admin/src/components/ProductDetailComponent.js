...
const ProductDetail = (props) => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-2xl shadow-md mt-4">
      <h2 className="text-2xl font-bold text-center mb-6">PRODUCT DETAIL</h2>
      <form className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-4">
          <button className="bg-gray-900 text-white px-4 py-2 rounded hover:bg-black" onClick={btnAddClick}>
            ADD NEW
          </button>
          <button className="bg-gray-900 text-white px-4 py-2 rounded hover:bg-black" onClick={btnUpdateClick}>
            UPDATE
          </button>
          <button className="bg-gray-900 text-white px-4 py-2 rounded hover:bg-black" onClick={btnDeleteClick}>
            DELETE
          </button>
          <button className="bg-gray-900 text-white px-4 py-2 rounded hover:bg-black" onClick={clearAllInputs}>
            RESET
          </button>
        </div>
